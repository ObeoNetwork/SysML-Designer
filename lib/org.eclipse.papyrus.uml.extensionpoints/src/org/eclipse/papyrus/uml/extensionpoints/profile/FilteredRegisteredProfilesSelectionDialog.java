...
/**
 * Shows a list of registered profiles to the user with a text entry field for a string pattern used
 * to filter the list of resources.
 * 
 * @since 1.9.0
 */
public class FilteredRegisteredProfilesSelectionDialog extends FilteredRegisteredElementsSelectionDialog {

	/** ID for this dialog preferences section */
	protected static final String DIALOG_SETTINGS = Activator.PLUGIN_ID + "dialogs.registeredprofiles";
