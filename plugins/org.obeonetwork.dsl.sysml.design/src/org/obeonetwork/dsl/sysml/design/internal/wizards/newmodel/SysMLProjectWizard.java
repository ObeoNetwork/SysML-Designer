 ...
 */
public class SysMLProjectWizard extends AbstractUmlProjectWizard {
	/**
	...
	public void addPages() {
		super.addPages();
		getNewProjectPage().setTitle("Create a SysML Modeling project");
		getModelPage().setTitle(Messages.SysMLModelWizard_UI_InitModelPageTitle);
	}
	...
	public boolean performFinish() {
		...
		Display.getDefault().syncExec(new Runnable() {
			public void run() {
				final Option<ModelingProject> created = ModelingProject.asModelingProject(getProject());
				if (created.some()) {
